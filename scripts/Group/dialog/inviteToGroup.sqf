...
if ((typeOf cursorTarget in ["C_Man_1","Epoch_Male_F","Epoch_Female_F","Survivor3_DZ","Survivor4_DZ","Bandit2_DZ","SurvivorW2_DZ","Survivor2_DZ","Sniper1_DZ","Camo1_DZ","BanditW1_DZ","Bandit1_DZ","Bandit3_DZ","Survivor5_DZ","SurvivorB_DZ","SurvivorR_DZ","Ranger_DZ"]) and (player distance cursorTarget <= 5)) then { _target = cursorTarget;_check = 1;_distance = 1; };
